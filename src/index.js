...
else if (window.location.href.slice(22, 40) === "dashboard-org")
{
  document.title = "Organization Dashboard | Queros";
  root.render(
    <React.StrictMode>
      <DashboardOrg />
    </React.StrictMode>
...
else if (window.location.href.slice(22, 40) === "dashboard-user")
{
  document.title = "User Dashboard | Queros";
  root.render(
    <React.StrictMode>
      <DashboardUser />
    </React.StrictMode>
